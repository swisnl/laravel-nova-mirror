<template>
    <div class="dropdown-menu absolute z-50 select-none" :class="menuClasses">
        ...
        <svg
            v-if="dark"
            class="absolute dropdown-arrow z-50"
            :class="arrowClasses"
            width="46px"
            height="23px"
        ...
        >
            <defs>
                <path id="a" d="M0 0h44v22H0z" />
                <path id="c" d="M2 22L22 2l20 20z" />
            </defs>
            <g fill="none" fill-rule="evenodd">
                <mask id="b" fill="#fff"><use xlink:href="#a" /></mask>
                <g mask="url(#b)">
                    <use fill="#F6F8FB" xlink:href="#c" />
                    <path stroke="#CCD4DB" d="M.793 22.5L22 1.293 43.207 22.5H.793z" />
                </g>
            </g>
        </svg>
